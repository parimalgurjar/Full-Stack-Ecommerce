              ...
              data.map((product, index) => (
                ...
                >
                  ...
                  <div className="p-4 grid gap-3">
                    <h2 className="font-medium text-base md:text-lg text-ellipsis line-clamp-1 bg-slate-500 animate-pulse">
                    ...
                    <div className="flex gap-4">
                      ...
                      <p className="text-slate-500 line-through  bg-slate-500 animate-pulse">
                        
                      </p>
                    </div>
                    <div>
                      <button className=" py-1 px-3 text-sm rounded-full w-full text-white  bg-slate-500 animate-pulse">
